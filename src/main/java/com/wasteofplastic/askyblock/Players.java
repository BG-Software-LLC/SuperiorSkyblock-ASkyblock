...
public class Players {
    ...
    private int deaths;
    private boolean disabledWorldBorder;
    ...
    public Players(final ASkyBlock aSkyBlock, final UUID uuid) throws IOException {
        ...
        this.disabledWorldBorder = false;
        load(uuid);
    }
    ...
    public void save(boolean async) {
        ...
        if (hasIsland) {
            if (plugin.getGrid() != null) {
                ...
                if (island != null) {
                    playerInfo.set("islandInfo", island);
                } 
            }
        }
        // Control panel
    ...
    public boolean isDisabledWorldBorder() {
        return disabledWorldBorder;
    }

    public void setDisabledWorldBorder(boolean disabledWorldBorder) {
        this.disabledWorldBorder = disabledWorldBorder;
    }
